...
public class AddBarang extends javax.swing.JDialog {
    ...
    private void initTable() {
        model = new javax.swing.table.DefaultTableModel(
          new Object[][][][]{},
                new String []{"TIPE BARANG",",MEREK", "JENIS", "KODE BARANG"}
        );
    ...
    private void initComponents() {
        ...
        txtTipeBarang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtTipeBarangActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtId)
                                    .addComponent(txtTipeBarang, javax.swing.GroupLayout.DEFAULT_SIZE, 469, Short.MAX_VALUE)))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(203, 203, 203)
    ...
    private void txtTipeBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtTipeBarangActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtTipeBarangActionPerformed
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
       String txt_tipebarang = txtTipeBarang.getText();
       String txt_merek = txtMerek.getText();
       String txt_jenis = txtJenis.getText();
       String txt_kodebarang = txtKodeBarang.getText();
       Object[] item= {txt_tipebarang,txt_merek, txt_jenis, txt_kodebarang};
       model.addRow(item);
    }//GEN-LAST:event_btnTambahActionPerformed

    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        String id_barang = txtId.getText();
        String tipebarang = txtTipeBarang.getText();
        int row = tabelItem.getRowCount();
        
        if (id_barang.isEmpty() || tipebarang.isEmpty()){
            JOptionPane.showMessageDialog(this, "Mohon Lengkapi Data!");
        }else if(row == 0){
            JOptionPane.showMessageDialog(this, "Item Masih Kosong");
        }else{
            List<Barang> p = new ArrayList<>();
            for (int i = 0; i<row; i++){
                String merek = tabelItem.getValueAt(i,1).toString();
                String jenis = tabelItem.getValueAt(i,2).toString();
                String kodebarang = tabelItem.getValueAt(i,3).toString();
                Barang pi = new Barang(merek, jenis, kodebarang);
                p.add(pi);
            }
            
            MainForm.gudang.setId(id_barang);
            MainForm.gudang.setTipe(tipebarang);
            MainForm.gudang.setBarangs(p);
